...
namespace TechnoVision.controller
{
    ...
    {
        public static void FillFormOne(string orderNumber, string orderDate, string dueDate, string testedBy, string orderStatus, double total, double advance, double discount, double balance , string paymentMethod , string PaymentPlan,int ReminderDays , string jobType,int custid)
        {
