        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    receiptController.FillReceipt(int.Parse(LenseOrder.OrderNumber), LenseOrder.Advance, LenseOrder.OrderDate,"LENSE");
