...
namespace TechnoVision {
    ...
    public partial class technovisionDataSet : global::System.Data.DataSet {
        ...
        public partial class receiptDataTable : global::System.Data.TypedTableBase<receiptRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public receiptRow AddreceiptRow(System.DateTime ReceiptDate, string OrderNumber, double PaymentAmount, int Branch) {
        ...
        public partial class customerRow : global::System.Data.DataRow {
            ...
            public uint Id {
                get {
                    return ((uint)(this[this.tablecustomer.IdColumn]));
                }
                set {
...
namespace TechnoVision.technovisionDataSetTableAdapters {
    ...
    public partial class spectaclesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("AddRightSph", "AddRight");
            tableMapping.ColumnMappings.Add("AddLeftAxis", "AddLeft");
            ...
            this._adapter.UpdateCommand = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE `spectacles` SET `OrderNumber` = @p1, `OrderDate` = @p2, `DueDate` = @p3, `OrderStatus` = @p4, `Total` = @p5, `Advance` = @p6, `Discount` = @p7, `Balance` = @p8, `TestBy` = @p9, `EyeWear` = @p10, `Lense` = @p11, `PaymentPlan` = @p12, `PaymentMethod` = @p13, `DistRightSph` = @p14, `DistRightCyl` = @p15, `DistRightAxis` = @p16, `DistLeftSph` = @p17, `DistLeftCyl` = @p18, `DistLeftAxis` = @p19, `AddRight` = @p20, `AddLeft` = @p21, `LenseType` = @p22, `Frame` = @p23, `PD` = @p24, `SegmentHight` = @p25, `SpecialInstractions` = @p26, `Remarks` = @p27, `ReminderDate` = @p28, `Branch` = @p29 WHERE ((`Id` = @p30) AND (`OrderNumber` = @p31) AND (`OrderDate` = @p32) AND (`DueDate` = @p33) AND (`OrderStatus` = @p34) AND (`Total` = @p35) AND (`Advance` = @p36) AND (`Discount` = @p37) AND (`Balance` = @p38) AND (`TestBy` = @p39) AND (`EyeWear` = @p40) AND (`Lense` = @p41) AND (`PaymentPlan` = @p42) AND (`PaymentMethod` = @p43) AND (`DistRightSph` = @p44) AND (`DistRightCyl` = @p45) AND (`DistRightAxis` = @p46) AND (`DistLeftSph` = @p47) AND (`DistLeftCyl` = @p48) AND (`DistLeftAxis` = @p49) AND (`AddRight` = @p50) AND (`AddLeft` = @p51) AND (`LenseType` = @p52) AND (`Frame` = @p53) AND (`PD` = @p54) AND (`SegmentHight` = @p55) AND (`SpecialInstractions` = @p56) AND (`Remarks` = @p57) AND (`ReminderDate` = @p58) AND (`Branch` = @p59))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            param = new global::MySql.Data.MySqlClient.MySqlParameter();
            param.ParameterName = "@p1";
            param.DbType = global::System.Data.DbType.String;
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[34].Value = ((double)(p35));
    ...
    public partial class receiptTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `receipt` WHERE ((`Id` = @p1) AND (`ReceiptDate` = @p2) AND (`OrderNu" +
                "mber` = @p3) AND (`PaymentAmount` = @p4) AND (`Branch` = @p5))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            global::MySql.Data.MySqlClient.MySqlParameter param = new global::MySql.Data.MySqlClient.MySqlParameter();
            param.ParameterName = "@p1";
            param.DbType = global::System.Data.DbType.Int32;
            ...
            this._adapter.InsertCommand = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO `receipt` (`ReceiptDate`, `OrderNumber`, `PaymentAmount`, `Branch`) V" +
                "ALUES (@p1, @p2, @p3, @p4)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            param = new global::MySql.Data.MySqlClient.MySqlParameter();
            param.ParameterName = "@p1";
            ...
            this._adapter.UpdateCommand = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE `receipt` SET `ReceiptDate` = @p1, `OrderNumber` = @p2, `PaymentAmount` = " +
                "@p3, `Branch` = @p4 WHERE ((`Id` = @p5) AND (`ReceiptDate` = @p6) AND (`OrderNum" +
                "ber` = @p7) AND (`PaymentAmount` = @p8) AND (`Branch` = @p9))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            param = new global::MySql.Data.MySqlClient.MySqlParameter();
            param.ParameterName = "@p1";
            param.DbType = global::System.Data.DbType.Date;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT `Id`, `ReceiptDate`, `OrderNumber`, `PaymentAmount`, `Branch` FROM `receip" +
                "t`";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            ...
            this._commandCollection[2] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT MAX(Id) FROM receipt WHERE Branch = @branchID";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            global::MySql.Data.MySqlClient.MySqlParameter param = new global::MySql.Data.MySqlClient.MySqlParameter();
            param.ParameterName = "@branchID";
            param.DbType = global::System.Data.DbType.Int32;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int p1, System.DateTime p2, string p3, double p4, int p5) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(p1));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(System.DateTime p1, string p2, double p3, int p4) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime p1, string p2, double p3, int p4, int p5, System.DateTime p6, string p7, double p8, int p9) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual object getReceiptNumberByBranch(int branchID) {
            global::MySql.Data.MySqlClient.MySqlCommand command = this.CommandCollection[2];
            command.Parameters[0].Value = ((int)(branchID));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
